...
from Frames import UserFrame, Setting, MyFrame
...
class PomodoroTimer(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.timer_label = tk.StringVar(value=self.schedule_timer[0])

        frame_1 = UserFrame(MyFrame, container, self, lambda: self.show_frame(Setting))
        self.frames[UserFrame] = frame_1

        frame_0 = MyFrame(container, self, lambda: self.show_frame(UserFrame))
        self.frames[MyFrame] = frame_0
